...
//     console.log(chalk.blueBright("Booking process started..."));
// });

// bookingEmitter.on("bookingValidated", () => {
//     console.log(chalk.cyanBright("Booking details validated successfully..."));
// });

// bookingEmitter.on("bookingConfirmed", (booking) => {
//     console.log(chalk.greenBright(("\nBooking confirmed.")));
//     console.log(chalk.greenBright(`Booking Id: ${booking.bookingId}`));
// });

// bookingEmitter.on("bookingCancelled", (booking) => {
//     console.log(chalk.yellowBright(`Booking cancelled for movie: ${booking.movieTitle} at ${booking.time}`));
// });

// bookingEmitter.on("bookingFailed", (error) => {
//     console.log(chalk.redBright(`Booking failed for Id: ${error}`));
// });
...
//             console.log(chalk.cyan(` -${show.time} | Seats Available: ${show.seatsavailable}`));
//         });
//     });
// }
...
//         }
//             break;
//         case "6": console.log(chalk.green("Thank you bye bye"));
//             rl.close(); break;
//         default:
