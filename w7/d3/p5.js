...
const secretKey = "monkey123"; // In production, use environment variables to store secrets
...
console.log("Token gnerated successfully:\n", token);
...
try{
    ...
    // if we ad this we'll get invalid token key
        // const newverifiedPayload = jwt.verify(token, newsecretKey);
